...
class ImageShow2Adapter(private val context: BookingDoneActivity, private val imageUris: MutableList<Uri>) :
    RecyclerView.Adapter<ImageShow2Adapter.ImageViewHolder>() {
